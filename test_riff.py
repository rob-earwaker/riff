...
class Test_ChunkData_detach(unittest.TestCase):
    ...
    def test_does_not_call_stream_detach_method(self):
        iostream = io.BytesIO(b'SomeMockTestData')
        iostream.detach = unittest.mock.Mock()
        iostream.seek(4)
        data = riff.ChunkData.streamfrom(iostream, size=8)
        try:
            data.detach()
            ...
            pass
        iostream.detach.assert_not_called()
...
class Test_ChunkData_fileno(unittest.TestCase):
    def test_returns_stream_fileno(self):
        ...
        iostream.fileno = unittest.mock.Mock(return_value=mock)
        iostream.seek(4)
        data = riff.ChunkData.streamfrom(iostream, size=8)
    ...
    def test_ValueError_if_closed(self):
        iostream = io.BytesIO(b'SomeMockTestData')
        iostream.fileno = unittest.mock.Mock()
        iostream.seek(4)
        data = riff.ChunkData.streamfrom(iostream, size=8)
        data.close()
        with self.assertRaises(ValueError) as ctx:
...
class Test_ChunkData_isatty(unittest.TestCase):
    def test_returns_whether_stream_isatty(self):
        iostream = io.BytesIO(b'SomeMockTestData')
        mock = unittest.mock.Mock()
        iostream.isatty = unittest.mock.Mock(return_value=mock)
        iostream.seek(4)
        data = riff.ChunkData.streamfrom(iostream, size=8)
    ...
    def test_ValueError_if_closed(self):
        iostream = io.BytesIO(b'SomeMockTestData')
        iostream.isatty = unittest.mock.Mock()
        iostream.seek(4)
        data = riff.ChunkData.streamfrom(iostream, size=8)
        data.close()
        with self.assertRaises(ValueError) as ctx:
...
class Test_ChunkData_read1(unittest.TestCase):
    def test_does_not_require_raw_stream_read1_attr(self):
        iostream = io.BytesIO(b'SomeMockTestData')
        iostream.read1 = unittest.mock.Mock(side_effect=AttributeError)
        iostream.seek(4)
        data = riff.ChunkData.streamfrom(iostream, size=8)
    ...
    def test_reads_all_bytes_by_default(self):
        ...
        iostream = io.BufferedReader(raw, buffer_size=4)
        iostream.seek(4)
        data = riff.ChunkData.streamfrom(iostream, size=8)
        self.assertEqual(b'MockTest', data.read1())
    ...
    def test_read_less_than_buffer_size_bytes(self):
        raw = io.BytesIO(b'SomeMockTestData')
        iostream = io.BufferedReader(raw, buffer_size=5)
        iostream.seek(4)
        data = riff.ChunkData.streamfrom(iostream, size=8)
    ...
    def test_read_more_than_buffer_size_bytes(self):
        raw = io.BytesIO(b'SomeMockTestData')
        iostream = io.BufferedReader(raw, buffer_size=3)
        iostream.seek(4)
        data = riff.ChunkData.streamfrom(iostream, size=8)
        self.assertEqual(b'Mock', data.read1(4))
...
class Test_ChunkData_readable(unittest.TestCase):
    def test_returns_whether_stream_readable(self):
        iostream = io.BytesIO(b'SomeMockTestData')
        mock = unittest.mock.Mock()
        iostream.readable = unittest.mock.Mock(return_value=mock)
        iostream.seek(4)
        data = riff.ChunkData.streamfrom(iostream, size=8)
    ...
    def test_ValueError_if_closed(self):
        iostream = io.BytesIO(b'SomeMockTestData')
        iostream.readable = unittest.mock.Mock()
        iostream.seek(4)
        data = riff.ChunkData.streamfrom(iostream, size=8)
        data.close()
        with self.assertRaises(ValueError) as ctx:
